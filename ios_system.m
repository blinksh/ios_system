...
int ios_stdinFd(void) {
    return thread_stdin ? fileno(thread_stdin) : 0;
}

int ios_stdoutFd(void) {
    return thread_stdout ? fileno(thread_stdout) : 0;
}

int ios_stderrFd(void) {
    return thread_stderr ? fileno(thread_stderr) : 0;
}
